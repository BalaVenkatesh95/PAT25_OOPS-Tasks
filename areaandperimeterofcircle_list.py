'''
Calculate area and perimeter of circle with given list
'''
...
perimeter_calculation = circle_calculation.calculate_perimeter()
print("Perimeter of circle:", perimeter_calculation)
